...
public class Swiat implements Serializable {
    ...
    JFrame frame;
    SaveManager SM;
    public Swiat(String typeString) {
        tpye=typeString;
    ...
    public void init(int a, int b) {
        ...
        logField.setSize(300, h*grid_size);
        logField.setLocation(w*grid_size, 0);

        infoField = new JTextArea();
        infoField.setEditable(false);
        infoField.setSize(500, 30);
        infoField.setLocation(w*grid_size-120, h*grid_size);

        

        save_Button.setBounds(0, grid_size * this.get_h(), 100, 30);
        load_Button.setBounds(100, grid_size * this.get_h(), 100, 30);
